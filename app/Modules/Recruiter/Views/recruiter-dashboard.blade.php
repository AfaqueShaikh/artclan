                        ...
                        <div class="eduDetails">
                            <div class="eduDetails">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook" id="facebook"  @if(isset(Auth::user()->facebook)) value="{{Auth::user()->facebook}}" @endif
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Twitter Link</label>
                                    <input type="text" name="twitter" id="twitter" @if(isset(Auth::user()->twitter)) value="{{Auth::user()->twitter}}" @endif
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Instagram Link</label>
                                    <input type="text" name="instagram" id="instagram" @if(isset(Auth::user()->instagram)) value="{{Auth::user()->instagram}}" @endif
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Know Me</label>
