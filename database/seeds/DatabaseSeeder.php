...
//        Insert Global values table data
        ...
        {
            DB::table('email_templates')->insert(['name'=>$name,'value'=>'','parameter'=>$email_tamplate['parameter'][$index],'validate'=>$email_tamplate['validate'][$index],'subject'=>$email_tamplate['subject'][$index],'template_key'=>$email_tamplate['template_key'][$index]]);
        }
    }
}
