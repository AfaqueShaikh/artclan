...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo e(url('admin/artist/list')); ?>">Manage Artists List</a></li>
                  ...
                  <div class="x_title">
                    <h2>Manage Artists Category</h2>
                      <div class="pull-right">
                          <a href="<?php echo e(url('admin/artist/category/create/'.Request::segment(5))); ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>
                      </div>
...
$(document).ready(function () {
    $('#users').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(url('/admin/artist/category/data/'.Request::segment(5))); ?>",
        columns: [
            {data: 'name', name: 'name'},
            {data: "action",
                render: function (data, type, row) {
                    if (type === 'display') {
                        return '<a class="btn btn-primary btn-xs" href="<?php echo e(url("admin/artist/category/update/")); ?>/' + row.id + '"><i class="fa fa-edit"></i>Update</a>';
                    }
                    return data;
                },
