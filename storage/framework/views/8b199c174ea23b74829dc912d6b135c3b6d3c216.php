    ...
    <div class="tab-content">
        ...
        <div id="home" class="tab-pane in active fade">
            ...
            <div class="form-group<?php echo e($errors->has('mobile') ? ' has-error' : ''); ?>">
                ...
                <div class="col-md-10">
                    <input id="mobile" type="text" class="form-control" name="mobile" value="<?php echo e(old('mobile')); ?>" >
        ...
        <div id="menu2" class="tab-pane in  fade">
            ...
            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?>">
                ...
                <div class="col-md-10">
                    <input id="date_of_birth" type="date" class="form-control" name="date_of_birth" value="<?php echo e(old('date_of_birth')); ?>" >
        ...
        <div id="menu3" class="tab-pane in fade">
            ...
            <div class="form-group<?php echo e($errors->has('all') ? ' has-error' : ''); ?>">
                <label for="mobile" class="col-md-2 control-label">Where Are You Available For Work ?</label>

                <input id="all" type="checkbox" class="" name="all" value="<?php echo e(old('all')); ?>" >Any where in india<br>
                <div class="col-md-10 work-location">
                    

                    <?php if($errors->has('all')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('all')); ?></strong>
                        </span>
                    <?php endif; ?>
                </div>
...
<script>
    ...
    {
        $.ajax({
            url: '<?php echo e(url("/get/location")); ?>',
            method: "GET",
            dataType: 'json',
            data: {
