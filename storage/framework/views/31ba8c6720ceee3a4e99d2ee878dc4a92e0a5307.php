			...
			<div class="navbar-right">
				<ul class="menus">
					...
					<li><a href="javascript:void(0);" class="color-red" data-toggle="modal" data-target="#signup">Sign up</a></li>
						<?php endif; ?>
					<?php if(Auth::check()): ?>
						<li><a href="<?php echo e(url('logout')); ?>" class="color-red" >Logout</a></li>
						<?php endif; ?>
				</ul> 				
		...
		<div class="sidemenu">
			...
			<div class="sidenavLogo">
				<?php if(isset(Auth::user()->profile_img)): ?>
					<a href="javascript:void(0);"><img src="<?php echo e(url('storage/app/public/user_profile/'.Auth::user()->profile_img)); ?>" alt="Weizmann Forex" width="127"></a>
				<?php else: ?>
					<a href="javascript:void(0);"><img src="<?php echo e(url('public/image/noimagefound.png')); ?>" alt="Weizmann Forex" width="127"></a>
				<?php endif; ?>
			</div>
			<br>
...
<section class="dashboardWelcome">
		<div class="container">Welcome <?php echo e(Auth::User()->name); ?></div>
	</section>